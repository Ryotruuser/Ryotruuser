...
|:---:|:---:|
| Hub de produtividade modular (SPA). | Classificação inteligente de e-mails com IA. |
| `React` `TypeScript` `Mobile-First` | `React` `Python` `Gemini API` |
| [🔗 Ver Repositório](https://github.com/ryotruuser/multitask-app) | [🔗 Ver Repositório](https://github.com/ryotruuser) |
